...
async function run() {
    ...
    console.log("TripData Accommodations:");
    console.log(JSON.stringify(tripData.accommodations, null, 2));

    console.log("\nTripData Itinerary Sleep Blocks:");
    const sleepBlocks = tripData.itinerary?.filter(b => b.type === 'sleep');
    console.log(JSON.stringify(sleepBlocks, null, 2));
}

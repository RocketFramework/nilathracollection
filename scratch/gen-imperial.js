                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <header className="ej-hero">
                        <div className="hero-content">
                            ...
                            <p className="hero-sub">For 4 Travelers · Colombo → Kandy → Tea Country → Galle → South Coast</p>
                            ...
                            <div className="stat-pills">
                                ...
                                <span className="pill">Aman Galle Fort</span>
                    ...
                    <section className="ej-section">
                        ...
                        <div className="day-card reveal">
                            ...
                            <div className="day-right">
                                <div className="day-header">
                                    <h3 className="day-title">Tea Country → Galle · Helicopter Transfer #3</h3>
                                    <p className="day-meta"><strong>Hotel:</strong> Amangalla · Suite · Galle Fort · $982/night</p>
                                </div>
                                <div className="timeline">
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-amber"></div>
                                    ...
                                    <div className="timeline-item reveal-item">
                                        ...
                                        <div className="act-title">🚁 Helicopter Transfer — Tea Trails → Galle</div>
                                        <div className="act-desc">The most dramatic transfer of the journey — from misty highland plantations to sun-drenched colonial fort in under an hour. Air Senok / IWS Aviation private charter. Approx. 1 hour.<br/><span className="heli-pill">USD $2,000/hour · est. $2,000 per transfer</span></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-teal"></div>
                                        <div className="time">10:30</div>
                                        <div className="act-title">Check-in Amangalla, Galle Fort</div>
                                        <div className="act-desc">Aman property within the 17th-century Dutch Fort walls — UNESCO World Heritage Site. Suite with four-poster beds, freestanding bath, private garden. Butler assigned.</div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-blue"></div>
                                        <div className="time">12:00</div>
                                        <div className="act-title">Fine seafood lunch — Amangalla dining room</div>
                                        <div className="act-desc">Private table, Galle Fort views. <span className="ticket-pill">$25/person incl.</span></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-green"></div>
                                        <div className="time">14:00</div>
                                        <div className="act-title">Private butler-led Galle Fort tour</div>
                                        <div className="act-desc">Through 400-year-old UNESCO streets — Dutch Reformed Church, the old lighthouse, Flag Rock, historic spice warehouses.</div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-purple"></div>
                                        <div className="time">16:00</div>
                                        <div className="act-title">Amangalla Spa — The Baths</div>
                                        <div className="act-desc">Hydrotherapy suites, plunge pools, steam baths, sauna. 2-hour signature Aman treatment for all 4 guests. <span className="ticket-pill">$200/person incl.</span></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-amber"></div>
                                        <div className="time">Evening</div>
                                        <div className="act-title">Sunset on the Fort ramparts</div>
                                        <div className="act-desc">Champagne on the ancient walls as the Indian Ocean catches the last light. HB dinner at the Grand Verandah.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="day-card reveal">
                            ...
                            <div className="day-right">
                                <div className="day-header">
                                    <h3 className="day-title">Galle · Private Catamaran + Departure</h3>
                                </div>
                                <div className="timeline">
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-amber"></div>
                                        <div className="time">07:30</div>
                                        <div className="act-title">Final breakfast, Amangalla (HB)</div>
                                        <div className="act-desc"></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-blue"></div>
                                        ...
                                        <div className="act-desc">Exclusive use of a private crewed luxury catamaran departing Galle Harbour. Sail the southern coastline — snorkelling at Unawatuna reef, dolphin spotting off Mirissa, fresh seafood lunch prepared onboard by the vessel's chef, sunset cocktails on the foredeck. All 4 guests exclusive.<br/><span className="ticket-pill">Total incl.: $1,500</span></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-teal"></div>
                                        <div className="time">16:00</div>
                                        <div className="act-title">Return to Amangalla · check-out</div>
                                        <div className="act-desc"></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-copper"></div>
                                        <div className="time">17:00</div>
                                        <div className="act-title">🚁 Helicopter Transfer — Galle → Colombo BIA</div>
                                        <div className="act-desc">Final flight home. Air Senok private charter from Koggala area. Approx. 45 minutes.<br/><span className="heli-pill">USD $2,000/hour · est. $1,500 per transfer</span></div>
                                    </div>
                                    <div className="timeline-item reveal-item">
                                        <div className="timeline-dot dot-purple"></div>
                    ...
                    <section className="ej-section reveal">
                        ...
                        <div className="hotel-grid">
                            ...
                            <div className="hotel-card reveal">
                                {/* [Amangalla Galle Fort interior — four-poster bed, high ceilings, colonial grandeur] */}
                                ...
                                <div className="hotel-body">
                                    ...
                                    <div className="hotel-loc">Galle Fort (Aman Resorts)</div>
                                    <div className="hotel-room">Suite</div>
                                    <div className="hotel-rate">$982 / night</div>
                                    <ul className="hotel-bullets">
                                        <li>Within the ramparts of 17th-century Galle Fort — UNESCO World Heritage Site</li>
                                        <li>31 suites, four-poster beds, freestanding baths, private gardens</li>
                                        <li>The Baths — Aman's world-class hydrotherapy spa with plunge pools & Ayurveda</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="ej-section reveal">
                        <div className="transport-section">
                            ...
                            <p className="text-sm text-neutral-600 mb-6">Colombo→Kandy (45min) · Kandy→Tea Trails (30min) · Tea Trails→Galle (60min) · Galle→Colombo (45min)</p>
                        ...
                        <div className="pricing-table-container overflow-x-auto">
                            <table className="pricing-table min-w-[800px]">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Amangalla Galle Fort — Suite</td>
                                        <td>$982 × 2 rooms × 1 night</td>
                                        <td>$1,964</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Amangalla Spa — The Baths (Day 5)</td>
                                        <td>$200 × 4 persons</td>
                                        <td>$800</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr style={{ background: 'rgba(13, 27, 42, 0.03)' }}>
                                        ...
                                        <td style={{ fontWeight: 600 }}>$21,624</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr style={{ background: 'rgba(13, 27, 42, 0.03)' }}>
                                        ...
                                        <td style={{ fontWeight: 600 }}>$25,949</td>
                                    </tr>
                                    <tr>
                            ...
                            <p className="price-note">
                                ...
                                <em>Rates are indicative for the 2025/2026 season. Helicopter rate fixed at USD $2,000/hour as quoted. Ceylon Tea Trails Master Suite rate from resplendentceylon.com and Mr & Mrs Smith (from ~$1,040/night per suite). Amangalla rate from Google Hotels / Aman.com ($982/night with taxes). Catamaran rate sourced from sailo.com (~$1,100–$1,500/day for private full charter in Sri Lanka). All site entrance fees are included. The $48,000 package rate reflects priority holds at Aman and Relais & Châteaux properties, peak season demand, exclusive helicopter allocation, and premium concierge service.</em>
                            </p>
                        </div>
                    </section>
                </div>
...
fs.mkdirSync(path.join(__dirname, 'src/app/imperial-helicopter'), { recursive: true });
fs.writeFileSync(path.join(__dirname, 'src/app/imperial-helicopter/page.tsx'), pageContent, 'utf-8');
console.log('Successfully wrote src/app/imperial-helicopter/page.tsx');

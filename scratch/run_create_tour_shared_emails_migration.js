...
async function run() {
    const sqlPath = path.join(__dirname, '../data/migrations/create_tour_shared_emails.sql');
    ...
    if (error) {
        ...
        console.log('Migration executed successfully! public.tour_shared_emails table created.');
    }
}

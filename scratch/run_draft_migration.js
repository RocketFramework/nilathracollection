...
async function run() {
    const sqlPath = path.join(__dirname, '../data/migrations/create_draft_itinerary_tables.sql');
    ...
    if (error) {
        ...
        console.log('Migration executed successfully! Tables public.draft_itinerary_versions and public.itinerary_locks created.');
    }
}

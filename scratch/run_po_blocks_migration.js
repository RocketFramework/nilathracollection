...
async function run() {
    const sqlPath = path.join(__dirname, '../data/migrations/02_create_po_blocks.sql');
    ...
    if (error) {
        ...
        console.log('Migration executed successfully! PO block tables and columns created.');
    }
}

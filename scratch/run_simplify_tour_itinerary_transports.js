...
async function run() {
    const sqlQuery = fs.readFileSync('data/migrations/simplify_tour_itinerary_transports.sql', 'utf8');
    console.log('Running simplify_tour_itinerary_transports migration...');

...
async function run() {
    const sqlQuery = fs.readFileSync('data/migrations/add_transport_requirements_relational.sql', 'utf8');
    console.log('Running Transport Requirements database migration...');

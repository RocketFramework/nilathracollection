...
async function run() {
    try {
        ...
        const blocks = await POBlockService.initializeDefaultBlocks('9bfb345a-da5d-443a-8644-90148b0b3a5a');
        console.log("Blocks:", blocks.map(b => ({ id: b.id, name: b.name, block_type: b.block_type })));

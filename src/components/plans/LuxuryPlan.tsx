...
export default function LuxuryPlan() {
    ...
    const nightRatePerPerson = 550; // flagship luxury rate
    const total = nightRatePerPerson * nights * travelers;

    const accommodation = 300 * nights * travelers;
    const transport = 50 * (nights + 1) * travelers;
    const meals = 70 * nights * travelers;
    const wellness = 40 * nights * travelers;
    const experiences = 40 * nights * travelers;
    const logistics = total - (accommodation + transport + meals + wellness + experiences);

...
export interface TourDailyTransportTotalDTO {
    tour_id: string;
    total_days: number;
    total_transport_rate: number;
    total_excess_mileage_cost: number;
    total_other_allowance: number;
    grand_total_transport_cost: number;

    total_charged_transport_rate?: number;
    total_charged_excess_mileage_cost?: number;
    total_charged_other_allowance?: number;
    grand_total_charged_transport_cost?: number;
}

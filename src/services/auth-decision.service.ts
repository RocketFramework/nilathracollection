import { AuthContext, Resource, DynamicPolicy, DynamicPermission } from '@/types/auth.types';
import { IAuthorizationRepository } from '@/other/auth-repository.interface';
import { SupabaseAuthorizationRepository } from './supabase-auth.repository';

export class AuthorizationEngine {
    private static repository: IAuthorizationRepository = new SupabaseAuthorizationRepository();

    // Allows dynamic swapping of repositories (e.g. for mock testing or future adapters)
    public static setRepository(repo: IAuthorizationRepository) {
        this.repository = repo;
    }

    public static getRepository(): IAuthorizationRepository {
     ...
     */
    public static async evaluate(context: AuthContext, resource: Resource, scope: string): Promise<boolean> {
        try {
    ...
    private static async evaluatePermission(
